 ...
 ***************************************************************************************<br>
 */
public interface NavigationCapture {
	/**
	 * this method controls the navigation of the inserted time entry
	 * @param nav to approve when ready
	 */
	void onNavigationAttempt(Navigation nav);
}
